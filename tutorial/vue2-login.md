# Add Login to your Vue 2 Application

_This tutorial has been migrated from the Auth0 Vue quickstart, and shows how to integrate Auth0 into a Vue 2 application using the [Auth0 SPA SDK](https://github.com/auth0/auth0-spa-js)._
...
![Auth0 Universal Login](universal-login.png)
